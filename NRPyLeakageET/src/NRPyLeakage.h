...
void NRPyLeakage_compute_GRMHD_source_terms_and_opacities_nrpy_constants_impl(const REAL rho_b,
                                                                              const REAL Y_e,
                                                                              const REAL T,
...
void NRPyLeakage_compute_GRMHD_source_terms_and_opacities_impl(const int which_constants_to_use,
                                                               const REAL rho_b,
                                                               const REAL Y_e,
                                                               const REAL T,
                                                               const REAL *restrict tau_nue,
...
void NRPyLeakage_compute_optical_depths_impl(const int N0,
                                             const int N1,
                                             const int N2,
                                             const int Ng0,
                                             const int Ng1,
