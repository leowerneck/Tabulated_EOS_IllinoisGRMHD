module EOS_Omni_Module
  ...
  real*8, allocatable :: hybrideos_eps(:)
  real*8, allocatable :: hybrideos_k(:)
  real*8, allocatable :: hybrideos_gamma(:)
  real*8, allocatable :: hybrideos_rho(:)

  ! stuff for the cold, tabulated EOS with a gamma law
  ! set by the reader routine
  logical :: coldeos_table_was_read = .false.
  ...
  ! set by the reader routine
  logical :: barotropiceos_table_was_read = .false.
  ...
  logical :: nuceos_table_was_read = .false.
  real*8 :: energy_shift
