...
tmp_41 = Y_e*((5.0/24.0)*tmp_3 + tmp_40)/((2.0/3.0)*MAX(mu_p*tmp_0, 0) + 1);
  ...
  *R_source = NRPyLeakage_amu*NRPyLeakage_units_cgs_to_geom_R*(-tmp_32/(((tau_nue[0])*(tau_nue[0]))*tmp_32*tmp_36*tmp_47/(tmp_34*tmp_39 + tmp_36*tmp_37*tmp_42 + tmp_39*tmp_45) + 1) + tmp_50/(((tau_anue[0])*(tau_anue[0]))*tmp_47*tmp_50*tmp_51/(tmp_34*tmp_53 + tmp_41*tmp_53 + tmp_53*tmp_55) + 1));
  *Q_source = NRPyLeakage_units_cgs_to_geom_Q*(-tmp_65/(((tau_nue[1])*(tau_nue[1]))*tmp_65*tmp_66*tmp_68/(tmp_34*tmp_70 + tmp_42*tmp_43*tmp_68 + tmp_45*tmp_70) + 1) - tmp_71/(((tau_anue[1])*(tau_anue[1]))*tmp_66*tmp_71*tmp_72/(tmp_34*tmp_74 + tmp_42*tmp_54*tmp_72 + tmp_55*tmp_74) + 1) - 4*(NRPyLeakage_C1pC2_nux_anux*NRPyLeakage_enable_pair_nux_anux*tmp_59/((exp(tmp_18) + 1)*(exp(tmp_18) + 1)) + NRPyLeakage_enable_plasmon_nux_anux*tmp_29*tmp_40*tmp_60/((exp(tmp_28) + 1)*(exp(tmp_28) + 1)) + tmp_56)/(((tau_nux[1])*(tau_nux[1]))*tmp_61*tmp_65*tmp_66/(tmp_34*tmp_35*tmp_62 + tmp_42*tmp_62) + 1));
}
