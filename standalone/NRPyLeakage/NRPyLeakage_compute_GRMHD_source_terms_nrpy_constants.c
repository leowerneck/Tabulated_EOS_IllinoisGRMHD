...
*/
  ...
  *Q_source = NRPyLeakage_units_cgs_to_geom_Q*(-tmp_42/(t_diff_1_nue*tmp_42*tmp_43/NRPyLeakage_Fermi_Dirac_integrals(3, tmp_7) + 1) - tmp_45/(t_diff_1_anue*tmp_43*tmp_45/NRPyLeakage_Fermi_Dirac_integrals(3, tmp_17) + 1) - 4*((1.0/9.0)*NRPyLeakage_C1pC2_nux_anux*NRPyLeakage_enable_pair_nux_anux*tmp_38/((exp(tmp_16) + 1)*(exp(tmp_16) + 1)) + NRPyLeakage_enable_plasmon_nux_anux*tmp_26*tmp_39*((NRPyLeakage_C_V - 1)*(NRPyLeakage_C_V - 1))/((exp(tmp_25) + 1)*(exp(tmp_25) + 1)) + tmp_35)/(t_diff_1_nux*tmp_42*tmp_43/NRPyLeakage_Fermi_Dirac_integrals(3, 0) + 1));
}
