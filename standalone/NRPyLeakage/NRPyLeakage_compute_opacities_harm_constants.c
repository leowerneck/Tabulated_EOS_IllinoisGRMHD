...
void NRPyLeakage_compute_opacities_harm_constants(const NRPyEOS_params *restrict eos_params,
  ...
  const REAL tmp_6 = NRPyLeakage_harm_N_A*NRPyLeakage_sigma_0*((T)*(T))*rho_b_cgs/((NRPyLeakage_harm_m_e_c2)*(NRPyLeakage_harm_m_e_c2));
  ...
  kappa_nue[0] = NRPyLeakage_harm_units_geom_to_cgs_L*(EnsureFinite(tmp_10*tmp_7) + EnsureFinite(tmp_11*tmp_7) + EnsureFinite(tmp_14*tmp_7));
  kappa_nue[1] = NRPyLeakage_harm_units_geom_to_cgs_L*(EnsureFinite(tmp_15*tmp_17) + EnsureFinite(tmp_10*tmp_15*tmp_6) + EnsureFinite(tmp_14*tmp_15*tmp_6));
  kappa_anue[0] = NRPyLeakage_harm_units_geom_to_cgs_L*(EnsureFinite(tmp_17*tmp_22) + EnsureFinite(tmp_10*tmp_22*tmp_6) + EnsureFinite(tmp_22*tmp_25*tmp_6));
  kappa_anue[1] = NRPyLeakage_harm_units_geom_to_cgs_L*(EnsureFinite(tmp_17*tmp_26) + EnsureFinite(tmp_10*tmp_26*tmp_6) + EnsureFinite(tmp_25*tmp_26*tmp_6));
  kappa_nux[0] = NRPyLeakage_harm_units_geom_to_cgs_L*(EnsureFinite(tmp_17*tmp_28) + EnsureFinite(tmp_10*tmp_28*tmp_6));
  kappa_nux[1] = NRPyLeakage_harm_units_geom_to_cgs_L*(EnsureFinite(tmp_17*tmp_30) + EnsureFinite(tmp_10*tmp_30*tmp_6));
