...
pngcrush NRPyLeakage_semi_analytic_results_beta_only.png && mv pngout.png NRPyLeakage_semi_analytic_results_beta_only.png
pngcrush NRPyLeakage_semi_analytic_results_all.png && mv pngout.png NRPyLeakage_semi_analytic_results_all.png
