...
typedef struct _harm_auxiliary_vars_ {
  CCTK_REAL Bsq,QdotBsq,Qsq,Qtsq,Qdotn,QdotB,D,gamma,gamma_times_S,ye,T_guess;
  bool use_entropy;
...
***********************************************************************/
static inline void raise_g(const CCTK_REAL vcov[NDIM], const CCTK_REAL gcon[NDIM][NDIM], CCTK_REAL vcon[NDIM])
{
  int i,j;
...
/**********************************************************************
     lower_g():
          ...
          -- calculates the ocvariant form of a contravariant tensor
             using the metric;
***********************************************************************/
static inline void lower_g(const CCTK_REAL vcon[NDIM], const CCTK_REAL gcov[NDIM][NDIM], CCTK_REAL vcov[NDIM])
{
  int i,j;
...
***********************************************************************/
static inline void ncov_calc(const CCTK_REAL gcon[NDIM][NDIM],CCTK_REAL ncov[NDIM])
{
  CCTK_REAL lapse ;
  int i;
...
*/
static inline CCTK_REAL pressure_rho0_u(const igm_eos_parameters eos, const CCTK_REAL rho0, const CCTK_REAL u)
{
...
*/
static inline CCTK_REAL pressure_rho0_w(const igm_eos_parameters eos, const CCTK_REAL rho0, const CCTK_REAL w)
{
