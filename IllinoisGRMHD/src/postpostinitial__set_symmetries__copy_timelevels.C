...
extern "C" void IllinoisGRMHD_PostPostInitial_Set_Symmetries__Copy_Timelevels(CCTK_ARGUMENTS) {
  ...
  if(CCTK_EQUALS(Symmetry,"equatorial")) {
    ...
    int ierr;
    ierr=CartSymGN(cctkGH,"IllinoisGRMHD::grmhd_conservatives"); if(ierr!=0) CCTK_ERROR("Microsoft error code #1874109358120048. Grep it in the source code");
    ierr=CartSymGN(cctkGH,"IllinoisGRMHD::grmhd_B_center"); if(ierr!=0) CCTK_ERROR("Microsoft error code #1874109358120049. Grep it in the source code");
    ...
    IllinoisGRMHD_set_symmetry_gzs_staggered(cctkGH,x,y,z,  By_center, gridfunc_syms_Bx,0,0,0);
