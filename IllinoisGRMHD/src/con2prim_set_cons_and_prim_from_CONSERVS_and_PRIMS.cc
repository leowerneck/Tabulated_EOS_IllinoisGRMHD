...
void set_cons_from_PRIMS_and_CONSERVS( const igm_eos_parameters eos,
  ...
  //--------------- Entropy ----------------
  //----------------------------------------
  if( (c2p_key == old_Noble1D_entropy ) ||
      (c2p_key == old_Noble1D_entropy2) ||
      (c2p_key == old_Palenzuela1D    ) ||
      (c2p_key == old_Newman1D        ) ) {
...
void set_prim_from_PRIMS_and_CONSERVS( const igm_eos_parameters eos,
  ...
  if( (c2p_key == old_Noble2D         ) ||
      (c2p_key == old_Noble1D         ) ||
      (c2p_key == old_Noble1D_entropy ) ||
      (c2p_key == old_Noble1D_entropy2) ||
      (c2p_key == old_CerdaDuran2D    ) ||
      (c2p_key == old_CerdaDuran3D    ) ) {
