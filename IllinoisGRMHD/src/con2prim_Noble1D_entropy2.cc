...
// Declarations:
int Utoprim_new_body_1d_ee2( const igm_eos_parameters eos,
...
int con2prim_Noble1D_entropy2( const igm_eos_parameters eos,
  ...
  return( Utoprim_new_body_1d_ee2(eos, cons, g4dn, g4up, prim) );
                             ...
                             CCTK_REAL *restrict prim )
{
  ...
  retval = newton_raphson_1d( x_1d, 1, eos, harm_aux, W_last, func_rho2 );
  rho0 = x_1d[0];
