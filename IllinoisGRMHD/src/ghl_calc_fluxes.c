    ...
    for(int j=jmin; j<jmax+1; j++) {
      for(int i=imin; i<imax+1; i++) {
        ...
        for(int ind=0; ind<6; ind++) {
          ...
          B1_stencil[ind]    = ONE_OVER_SQRT_4PI*B_center[B_recon[1]][stencil];
          B2_stencil[ind]    = ONE_OVER_SQRT_4PI*B_center[B_recon[2]][stencil];
        ...
        prims_r.BU[B_recon[0]] = prims_l.BU[B_recon[0]] = ONE_OVER_SQRT_4PI*B_stagger[indm1]/ADM_metric_face.sqrt_detgamma;
